...
<template>
    ...
    <div
        class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6 max-w-4xl mx-auto w-full"
    >
        ...
        >
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Detailed information for student record #{{
                            student.id
                        }}
                    </p>
                </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <Button as-child variant="destructive" class="gap-2">
                    <Link
                        :href="studentsRoute.destroy(student.id)"
                        method="delete"
                        as="button"
                    >
        ...
        <Card class="border-sidebar-border/70 overflow-hidden shadow-xs">
            <div
                class="p-6 md:p-8 bg-linear-to-r from-primary/5 via-primary/10 to-transparent"
            >
                <div
                ...
                >
                    <!-- Big Avatar Circle -->
                    <div
                        class="flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground font-bold text-2xl shadow-md border-2 border-background"
                    >
                    ...
                    <!-- Status / Badge -->
                    <div
                        class="flex flex-wrap sm:flex-col items-start sm:items-end gap-2 shrink-0"
                    >
                        <Badge
                            variant="outline"
                            class="gap-1.5 bg-background/80 backdrop-blur-xs py-1 px-3"
                        >
                            <ShieldCheck
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <Card class="border-sidebar-border/70 shadow-xs">
                ...
                <CardContent class="space-y-4">
                    <!-- Class Details -->
                    <div
                        class="flex items-center justify-between p-3.5 rounded-lg bg-muted/40 border border-sidebar-border/50"
                    >
                        <div class="flex items-center gap-3">
                            <div
                                class="p-2 rounded-md bg-blue-100 dark:bg-blue-950/50 text-blue-700 dark:text-blue-400"
                            >
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div
                                class="p-2 rounded-md bg-emerald-100 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-400"
                            >
            ...
            <Card class="border-sidebar-border/70 shadow-xs">
                ...
                <CardContent class="space-y-4">
                    <!-- Full Name -->
                    <div
                        class="flex items-center justify-between py-2 border-b border-sidebar-border/50"
                    >
